...
**Awesome Books** A simple page to add and remove books built with javascript with focus on Javascript ES6 features.
...
- [Live Demo Link](https://bahirhakimy.github.io/AwesomeBooksES6/)
...
```bash
git clone https://github.com/BahirHakimy/AwesomeBooksES6.git
```
